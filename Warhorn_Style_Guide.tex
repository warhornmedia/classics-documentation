...
\hypertarget{parts-chapters-sections-and-more}{%
\subsection{Parts, chapters, sections, and more}\label{parts-chapters-sections-and-more}}
...
\FunctionTok{\#\#\#\# Here is a sub{-}sub{-}section}
\end{Highlighting}
\end{Shaded}
