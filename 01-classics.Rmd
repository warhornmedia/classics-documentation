...
Indent latter paragraph(s) in a footnote by four spaces to indicate that the footnote is continuing.[^3]

[^3]: Here is my multiparagraph footnote, just to prove that it works.
