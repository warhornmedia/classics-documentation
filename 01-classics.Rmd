...
Precede each line of poetry with a | and a space. (This makes a [line block](#https://pandoc.org/MANUAL.html#line-blocks) so there are line breaks between consecutive lines. We could also use a backslashe (\\) at the end of each line to do the same.) 
