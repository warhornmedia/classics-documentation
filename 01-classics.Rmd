...
3. If you are working on footnotes, make sure you didn't try to insert a footnote reference inside bold or italic text or from within chapter or section headers *if* the footnote itself has multiple paragraphs. (See warning in [footnote section](#footnotes).)2. Make sure every .Rmd file starts with either # or ##.
