...
The first steps of creating a new book from scratch from our book template, including creating the necessary repository on Github, are contained in the [book template](https://warhornmedia.github.io/warhorn-classics-book-template/01-Basic-instructions.html#creating-a-new-repo-for-a-new-book-on-github) itself. Please go and follow those instructions first if no repo exists for the book you are about to start working on. Then come back here.
