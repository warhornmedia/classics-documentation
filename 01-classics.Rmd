...
If the structure of the book demands a more detailed naming of footnotes, it may be appropriate to lengthen the names of footnotes for the sake of clarity. For example, footnotes in chapter 1, section 1, of a book might be named "01.01.01", "01.01.02", etc. The most important thing is that each footnote have a unique name.
