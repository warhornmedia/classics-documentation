...
**NOTE: [This still](https://github.com/warhornmedia/classics-documentation/issues/3) needs to be implemented in the HTML version. It works in PDF, ePub, and Mobi**
...
**NOTE: [This still](https://github.com/warhornmedia/classics-documentation/issues/7) needs to be implemented in the HTML, Mobi, and ePub versions. It works in PDF**
...
Endnotes can be created simply by creating a separate .Rmd file[^5] for them, and giving them named IDs and then [linking to them](#linking-to-an-endnote) as references from the body of the main text. In this way, they are not special links, and they are compatible with footnotes. The end of this sentence has an endnote to demonstrate what an endnote normally looks like. ([1](#en.01){#en.01.backlink})

**NOTE**: Endnotes created in this manner do *not* automatically backlink to the place they are referenced from. 
...
```markdown
This sentence ends with a linked endnote in parentheses.([2](#en.p1.02){#en.p1.02.backlink})
```
